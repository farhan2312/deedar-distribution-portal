...
const HI: Record<string, string> = {
  ...
  "no GPS": "जीपीएस नहीं",
  "New": "नया",
  "Packets sold today by rep": "रेप अनुसार आज बिके पैकेट",
  "Packets sold by rep": "रेप अनुसार बिके पैकेट",
  "Tap a rep for their last 3 days": "पिछले 3 दिन देखने के लिए रेप पर टैप करें",
