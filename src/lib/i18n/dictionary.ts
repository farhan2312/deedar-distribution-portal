...
const HI: Record<string, string> = {
  ...
  "State → C&F → Stockist → Area. Pick one to see what sits under it.": "राज्य → C&F → स्टॉकिस्ट → क्षेत्र। किसी एक को चुनें और उसके नीचे का देखें।",
  "Sub-Dealers": "सब-डीलर",
  "Pick a state": "एक राज्य चुनें",
  "Pick a C&F HQ": "एक C&F HQ चुनें",
  "Pick a dealer": "एक डीलर चुनें",
  "Pick a stockist": "एक स्टॉकिस्ट चुनें",
  ...
  "How many counters do I have?": "मेरे पास कितनी दुकानें हैं?",
  "Which stockist did the most visits today?": "आज सबसे ज़्यादा विज़िट किस स्टॉकिस्ट ने कीं?",
  "packets on hand": "पैकेट उपलब्ध",
  "incl. sub-dealers": "सब-डीलर सहित",
  "No stock recorded yet.": "अभी तक कोई स्टॉक दर्ज नहीं।",
  "Nothing is below its threshold.": "कुछ भी सीमा से नीचे नहीं है।",
  "product is running low.": "प्रोडक्ट कम हो रहा है।",
  "products are running low.": "प्रोडक्ट कम हो रहे हैं।",
  "Open Stock": "स्टॉक खोलें",
  "Open Counters": "दुकानें खोलें",
  "Areas": "क्षेत्र",
  ...
  "Add a dealer first.": "पहले एक डीलर जोड़ें।",
  "C&F-managed stock": "C&F प्रबंधित स्टॉक",
  "Third-party stock": "थर्ड-पार्टी स्टॉक",
  "Under a dealer": "डीलर के अंतर्गत",
  "under": "अंतर्गत",
  "Pick a stockist.": "एक स्टॉकिस्ट चुनें।",
  "Stockist": "स्टॉकिस्ट",
  "Stockists": "स्टॉकिस्ट",
  "All stockists": "सभी स्टॉकिस्ट",
  "Counters by stockist": "स्टॉकिस्ट के अनुसार दुकानें",
  "Stockist leaderboard": "स्टॉकिस्ट लीडरबोर्ड",
  "Stockist performance comparison": "स्टॉकिस्ट प्रदर्शन तुलना",
  "Stockists & Areas": "स्टॉकिस्ट और क्षेत्र",
  "No stockists yet.": "अभी तक कोई स्टॉकिस्ट नहीं।",
  "No stockists under this C&F yet.": "इस C&F के अंतर्गत अभी कोई स्टॉकिस्ट नहीं।",
  "in your stockists": "आपके स्टॉकिस्ट में",
  "Stockist:": "स्टॉकिस्ट:",
  "Stockist *": "स्टॉकिस्ट *",
  "Stockist name": "स्टॉकिस्ट का नाम",
  "Stockist added.": "स्टॉकिस्ट जोड़ा गया।",
  "Select stockist": "स्टॉकिस्ट चुनें",
  "Add stockist": "स्टॉकिस्ट जोड़ें",
  "Add a stockist": "स्टॉकिस्ट जोड़ें",
  "Add a stockist first.": "पहले स्टॉकिस्ट जोड़ें।",
  "e.g. Ramganj Mandi": "जैसे रामगंज मंडी स्टॉकिस्ट",
  "Fill name, stockist, area and type.": "नाम, स्टॉकिस्ट, क्षेत्र और प्रकार भरें।",
  "Your stockist": "आपका स्टॉकिस्ट",
  "No stockist": "कोई स्टॉकिस्ट नहीं",
  "You aren't assigned to a stockist yet — ask your Sales Officer to map you to one.": "आपको अभी तक किसी स्टॉकिस्ट से नहीं जोड़ा गया — अपने सेल्स ऑफिसर से पूछें।",
  "You aren't mapped to a stockist yet — ask Central Admin.": "आप अभी किसी स्टॉकिस्ट से मैप नहीं हैं — सेंट्रल एडमिन से पूछें।",
  "You don't have Stockist access.": "आपके पास स्टॉकिस्ट एक्सेस नहीं है।",
  "You don't supervise any stockists yet.": "आप अभी किसी स्टॉकिस्ट का पर्यवेक्षण नहीं करते।",
  "No counters mapped to your stockist yet.": "आपके स्टॉकिस्ट से अभी तक कोई दुकान मैप नहीं है।",
  "No field reps in your supervised stockists yet.": "आपके पर्यवेक्षण वाले स्टॉकिस्ट में अभी कोई फील्ड रेप नहीं है।",
  "No field reps report to you in this stockist yet.": "इस स्टॉकिस्ट में अभी तक कोई फील्ड रेप आपको रिपोर्ट नहीं करता।",
  "No stock recorded for this stockist yet.": "इस स्टॉकिस्ट के लिए अभी तक कोई स्टॉक दर्ज नहीं।",
  "Every counter at your stockist — tap Check in to open its page.": "आपके स्टॉकिस्ट की हर दुकान — पेज खोलने के लिए चेक इन दबाएँ।",
  "Every counter in the stockists you supervise — view only.": "आपके पर्यवेक्षण वाले स्टॉकिस्ट की हर दुकान — केवल देखने के लिए।",
  ", not your stockist — you can view it but can't add a visit.": " में है, आपके स्टॉकिस्ट में नहीं — आप देख सकते हैं पर विज़िट नहीं जोड़ सकते।",
  "This counter is at another stockist.": "यह दुकान दूसरे स्टॉकिस्ट में है।",
  "This counter isn't at your stockist, so you can't add a visit to it.": "यह दुकान आपके स्टॉकिस्ट में नहीं है, इसलिए आप विज़िट नहीं जोड़ सकते।",
  "This counter isn't at your stockist, so you can't edit it.": "यह दुकान आपके स्टॉकिस्ट में नहीं है, इसलिए आप संपादित नहीं कर सकते।",
  "It's at another stockist, so you can't add a visit to it from here.": "यह दूसरे स्टॉकिस्ट में है, इसलिए आप यहाँ से विज़िट नहीं जोड़ सकते।",
  "This mobile is registered to a counter at another stockist — you can't access it from here.": "यह नंबर दूसरे स्टॉकिस्ट की दुकान से जुड़ा है — आप यहाँ से एक्सेस नहीं कर सकते।",
  "Total stock": "स्टॉकिस्ट पर कुल स्टॉक",
  "Stockist counter / bulk sales (today)": "स्टॉकिस्ट काउंटर / बल्क बिक्री (आज)",
  "Wholesale outlets served by this stockist.": "इस स्टॉकिस्ट द्वारा सेवा किए जाने वाले थोक आउटलेट।",
  "Stock picked up from your stockist": "स्टॉकिस्ट से उठाया गया स्टॉक",
  "Performance across every stockist, area and rep in this C&F.": "इस C&F के हर स्टॉकिस्ट, क्षेत्र और रेप का प्रदर्शन।",
  "Track your team's performance and visits across your stockists.": "अपने स्टॉकिस्ट में टीम के प्रदर्शन और विज़िट को ट्रैक करें।",
  "Stockist (Field ISR)": "स्टॉकिस्ट (फील्ड ISR)",
  "Stockists (Sales Officer)": "स्टॉकिस्ट (सेल्स ऑफिसर)",
  "Stockist (Depot / Dealer)": "स्टॉकिस्ट (डिपो / डीलर)",
  "Full access — every section. No stockist / C&F / area needed.": "पूरी पहुँच — हर सेक्शन। स्टॉकिस्ट / C&F / क्षेत्र की आवश्यकता नहीं।",
  "New dealer": "नया डीलर",
  "New sub-dealer": "नया सब-डीलर",
  "sub-dealer": "सब-डीलर",
  "sub-dealers": "सब-डीलर",
  "Its sub-dealers and everything under them go too.": "इसके सब-डीलर और उनके नीचे का सब कुछ भी हट जाएगा।",
  "your stockists": "आपके स्टॉकिस्ट",
  "Dealer": "डीलर",
  "Sub-Dealer": "सब-डीलर",
  "FORGOT PASSWORD": "पासवर्ड भूल गए",
  "Enter your mobile number and your admin will reset your password.": "अपना मोबाइल नंबर भरें, आपका एडमिन आपका पासवर्ड रीसेट करेगा।",
  "Your admin will reset it and tell you the new password.": "आपका एडमिन इसे रीसेट करके आपको नया पासवर्ड बताएगा।",
  "Request sent. Please contact your admin if it's urgent.": "अनुरोध भेज दिया गया। ज़रूरी हो तो अपने एडमिन से संपर्क करें।",
  "Request password reset": "पासवर्ड रीसेट का अनुरोध करें",
  "Back to login": "लॉगिन पर वापस",
  "Remembered it?": "याद आ गया?",
  "Password reset requests": "पासवर्ड रीसेट अनुरोध",
  "No password reset requests.": "कोई पासवर्ड रीसेट अनुरोध नहीं।",
  "No account with this number": "इस नंबर से कोई खाता नहीं",
  "Resetting sets the password to the user's mobile number and forces them to change it at next login. Tell them in person or by phone — the app cannot.": "रीसेट करने पर पासवर्ड उनका मोबाइल नंबर बन जाता है और अगली लॉगिन पर बदलना ज़रूरी होगा। उन्हें खुद या फ़ोन पर बताएँ — ऐप नहीं बता सकता।",
  "Reset password": "पासवर्ड रीसेट करें",
  "Set to mobile number?": "मोबाइल नंबर पर सेट करें?",
  "Resetting…": "रीसेट हो रहा है…",
  "Password reset": "पासवर्ड रीसेट हुआ",
  "Dismiss": "खारिज करें",
  "Save": "सहेजें",
  "Confirm": "पुष्टि करें",
  ...
  // Portal top bar: page descriptions
  "Clock in, log the stock you picked up, and close out the day.": "क्लॉक इन करें, उठाया गया स्टॉक दर्ज करें, और दिन बंद करें।",
  "The counters assigned to you for today — check in as you go.": "आज आपको सौंपे गए काउंटर — जाते-जाते चेक इन करते रहें।",
  "You and your counters, plotted live.": "आप और आपके काउंटर, लाइव मैप पर।",
  "Add a retail outlet to your stockist's list.": "अपने स्टॉकिस्ट की सूची में एक रिटेल आउटलेट जोड़ें।",
  "Your field salesmen and their counters, plotted live.": "आपके फ़ील्ड सेल्समैन और उनके काउंटर, लाइव मैप पर।",
  "Clock-in and clock-out times for every field salesman in view.": "दिख रहे हर फ़ील्ड सेल्समैन का क्लॉक-इन / क्लॉक-आउट समय।",
  "Add a retail outlet to one of the stockists you supervise.": "आपके अधीन किसी स्टॉकिस्ट में एक रिटेल आउटलेट जोड़ें।",
  "Every field salesman and counter across this C&F, live.": "इस C&F के हर फ़ील्ड सेल्समैन और काउंटर, लाइव।",
  "The depots, dealers and areas that make up this C&F.": "इस C&F के डिपो, डीलर और एरिया।",
  // Period filter (company dashboard, ISR detail, Reports)
  "Yesterday": "कल",
  "Period": "अवधि",
  "This month": "इस महीने",
  "30 days": "30 दिन",
  "90 days": "90 दिन",
  "This FY": "इस वित्त वर्ष",
  "Last FY": "पिछला वित्त वर्ष",
  "Last 90 days": "पिछले 90 दिन",
  "days worked": "दिन काम किया",
  "one still open": "एक अब भी खुला",
  "No day started in this period": "इस अवधि में कोई दिन शुरू नहीं हुआ",
  "No activity in this period.": "इस अवधि में कोई गतिविधि नहीं।",
  "No counters added in this period.": "इस अवधि में कोई काउंटर नहीं जोड़ा गया।",
  "Day logs": "दिन के लॉग",
  ...
  // Audit log
  "Audit Log": "ऑडिट लॉग",
  "Who changed what, and when — every sign-in and every admin change.": "किसने क्या बदला और कब — हर साइन-इन और हर एडमिन बदलाव।",
  "Logins · 24h": "लॉगिन · 24घं",
  "Failed · 24h": "विफल · 24घं",
  "Active users · 24h": "सक्रिय उपयोगकर्ता · 24घं",
  "Actions · 24h": "क्रियाएँ · 24घं",
  "Activity heatmap": "गतिविधि हीटमैप",
  "By weekday and time of day": "दिन और समय के अनुसार",
  "Daily activity": "दैनिक गतिविधि",
  "Actions recorded per day": "प्रतिदिन दर्ज क्रियाएँ",
  "Action breakdown": "क्रियाओं का विभाजन",
  "Logins vs failed logins": "लॉगिन बनाम विफल लॉगिन",
  "Per day, over the selected period": "चुनी गई अवधि में, प्रतिदिन",
  "Top users by activity": "गतिविधि के अनुसार शीर्ष उपयोगकर्ता",
  "Actions in the selected period": "चुनी गई अवधि की क्रियाएँ",
  "Audit activity": "ऑडिट गतिविधि",
  "All modules": "सभी मॉड्यूल",
  "All actions": "सभी क्रियाएँ",
  "Module": "मॉड्यूल",
  "Action": "क्रिया",
  "Search user, record or change…": "उपयोगकर्ता, रिकॉर्ड या बदलाव खोजें…",
  "No entries match — try clearing the filter.": "कोई प्रविष्टि नहीं मिली — फ़िल्टर हटाकर देखें।",
  "Nothing in this period.": "इस अवधि में कुछ नहीं।",
  "Nobody was active in this period.": "इस अवधि में कोई सक्रिय नहीं था।",
  "Nothing has been recorded yet. The log fills as people sign in and admins make changes.": "अभी कुछ दर्ज नहीं हुआ है। जैसे-जैसे लोग साइन इन करेंगे और एडमिन बदलाव करेंगे, लॉग भरता जाएगा।",
  ...
  "field": "फ़ील्ड",
  "fields": "फ़ील्ड",
  "user active": "उपयोगकर्ता सक्रिय",
  "users active": "उपयोगकर्ता सक्रिय",
  "Create": "बनाया",
  "Update": "बदला",
  "Delete": "हटाया",
  "Failed login": "विफल लॉगिन",
  "Logout": "लॉगआउट",
  "Auth": "प्रमाणीकरण",
  "Access": "एक्सेस",
  "Mon": "सोम",
  ...
  "Sat": "शनि",
  "Sun": "रवि",
  // Audit log: tabs and usage table
  "Overall": "समग्र",
  "Usage & Time": "उपयोग और समय",
  "Logins & Sessions": "लॉगिन और सेशन",
  "Activity": "गतिविधि",
  "Ownership Changes": "स्वामित्व बदलाव",
  "7 days": "7 दिन",
  "Active time": "सक्रिय समय",
  "total active time": "कुल सक्रिय समय",
  "an approximation, not a stopwatch": "अनुमान है, स्टॉपवॉच नहीं",
  "First to last action each day — this app records what people do, not a heartbeat.": "हर दिन की पहली से आख़िरी क्रिया तक — यह ऐप गतिविधि दर्ज करता है, लगातार समय नहीं।",
  "localhost": "लोकलहोस्ट",
  "via": "के ज़रिए",
  "Last active": "अंतिम सक्रियता",
  "Role": "भूमिका",
  // Audit log: chart labels
  "Daily activity trend": "दैनिक गतिविधि रुझान",
  "Login vs failed login trend": "लॉगिन बनाम विफल लॉगिन रुझान",
  "Failed logins": "विफल लॉगिन",
  "Device breakdown": "डिवाइस विभाजन",
  "Browser and OS, from the user agent": "यूज़र एजेंट से ब्राउज़र और OS",
  ...
  "A reset was already requested for this number today. Please contact your admin.": "इस नंबर के लिए आज पहले ही रीसेट का अनुरोध किया जा चुका है। कृपया अपने एडमिन से संपर्क करें।",
  ...
  "Location is off, so your Sales Officer can't see you on the map. Turn it on in your browser settings — your day has still started.": "लोकेशन बंद है, इसलिए आपके सेल्स ऑफिसर आपको मैप पर नहीं देख पाएँगे। ब्राउज़र सेटिंग्स में इसे चालू करें — आपका दिन शुरू हो चुका है।",
};
